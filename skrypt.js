document.getElementById("btndalej").addEventListener("click",function(){
    var prawaramka = document.getElementById("prawaramkaniewidoczna")
    var lewaramka=document.getElementById("lewaramkawidoczna")
    prawaramka.id="prawaramkawidoczna";
    lewaramka.id="lewaramkaniewidoczna";
})
